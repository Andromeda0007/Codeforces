...
{
    while (n % 2 == 0)
        primefactors.pb(2), n = n / 2;
    for (int i = 3; i <= sqrt(n); i = i + 2)
        while (n % i == 0)
            primefactors.pb(i), n = n / i;
    if (n > 2)
        primefactors.pb(n);
}
//================================================================================================================//
...
void generatesubseq(string s1, string ans) // To generate all the subsequence of a string
{
    ...
    generatesubseq(rest, ans);
    generatesubseq(rest, ans + c1);
}
