...
signed main()
{
    ...
    testcase
    {
        ...
        double area = 0.5*b*h;
        long double tan = (2*h/b);

        long double totalarea = count*area;
        ...
        for(int i=0; i<n; i++)
        {
            ...
            {
                long double height = v2[i];
                long double base = height/tan;

                long double earea = height*base;
                totalarea += earea;

                long double rarea = height*(b-2.0000000*base);
                totalarea += rarea;
            }
        }

        cout << setprecision(15) << totalarea << endl;
